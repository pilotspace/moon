...
impl HnswGraph {
    ...
    // ---- pub(crate) accessors for graph_serde ----

    #[inline]
    pub(crate) fn layer0_neighbors_slice(&self) -> &[u32] {
        self.layer0_neighbors.as_slice()
    }

    #[inline]
    pub(crate) fn bfs_order_slice(&self) -> &[u32] {
        &self.bfs_order
    }

    #[inline]
    pub(crate) fn bfs_inverse_slice(&self) -> &[u32] {
        &self.bfs_inverse
    }

    #[inline]
    pub(crate) fn levels_slice(&self) -> &[u8] {
        &self.levels
    }

    #[inline]
    pub(crate) fn upper_index_slice(&self) -> &[u32] {
        &self.upper_index
    }

    #[inline]
    pub(crate) fn upper_offsets_slice(&self) -> &[u32] {
        &self.upper_offsets
    }

    #[inline]
    pub(crate) fn upper_neighbors_slice(&self) -> &[u32] {
