...
pub fn hnsw_search_with_trace(
    ...
    layers.push(HnswTraceLayer {
        ...
        visited: l0_visited,
        // Layer 0 returns at most `k` results (not `ef_search`) because
        // ef_search controls beam width during descent while k is the
        // caller-requested result count. Capping by ef would overstate.
