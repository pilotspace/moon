//! FT.SEARCH command handler and search helpers.
...
use super::{extract_bulk, matches_keyword, parse_u32, session};
...
pub fn ft_search_with_graph(
    ...
    let expanded = super::graph_expand::expand_results_via_graph(graph, &seed_keys, depth);
...
pub(crate) fn build_combined_response(
    knn_response: &Frame,
    expanded: &[super::graph_expand::ExpandedResult],
) -> Frame {
