...
pub fn config_rewrite(
    runtime_config: &RuntimeConfig,
    server_config: &ServerConfig,
) -> Frame {
    let mut lines = Vec::with_capacity(20);
    lines.push(format!("# Moon configuration file — generated by CONFIG REWRITE"));
    ...
    lines.push(format!("maxmemory-policy {}", runtime_config.maxmemory_policy));
    lines.push(format!("maxmemory-samples {}", runtime_config.maxmemory_samples));
